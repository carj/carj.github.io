...
Using webhooks, applications can send your data automatically to 3rd party systems when certain events are triggered with
...
This allows to custom business processes to be triggered based on events within Preservica.
