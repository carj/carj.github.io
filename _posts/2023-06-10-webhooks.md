...
The challenge response must take the form of a simple json document which is sent back to Preservica.
...
where hexHmac256Response is a hexadecimal encoded hmac256 of the challengeCode using the secret as the hmac key. 
