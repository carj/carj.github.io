...
In a previous [post](https://jcarr.org.uk/2023/06/10/webhooks/) I described how Preservica uses webhooks to allow the creation of custom buisness processes. At the end of the article I touched upon the deployment of webhooks within AWS and showed how serveless event driven cloud services are ideal for these kind of applications. Deploying to AWS can be complicated as a number of AWS services are required to work together.
