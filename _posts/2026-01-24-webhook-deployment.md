...
In a previous [post](https://jcarr.org.uk/2023/06/10/webhooks/), I described how Preservica uses webhooks to allow the creation of custom business processes. At the end of the article, I touched upon...  
...
We are going to use three Python projects: the web framework [Flask](https://flask.palletsprojects.com/en/stable/) to manage the application logic and create the web service that processes the messages from Preservica.  
